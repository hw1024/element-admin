<template>
  <div class="wws-chart-view">
    ...
    <div class="row">
      <div class="col col-md-3" id="averageDailyDepositBalance"></div>
      <div class="col col-md-3" id="dailyAverageBalanceOfLoans"></div>
      <div class="col col-md-3" id="billDiscountScale"></div>
      <div class="col col-md-3" id="billAcceptanceScale"></div>
    </div>
  ...
  mounted() {
    ...
    var option = {
      ...
      ProportionOfBusinessIncome: {
        chartTitle: '华通金租各业务收入占比',
        chartType: 'pie_E',
        data: [
          {name: '融资租赁业务', value: 10},
          {name: '经营租赁业务', value: 10},
          {name: '售后回租业务', value: 10},
          {name: '转租赁业务', value: 110},
          {name: '其他租赁业务', value: 10}
        ],
        height: 300
      },
      averageDailyDepositBalance: {
        title: '日均存款余额',
        scale: [
          {key: '计划完成率', val: '+108%'},
          {key: '同比增长率', val: '-108%'}
